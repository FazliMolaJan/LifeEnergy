...
import cn.dennishucd.qrcode.CameraManager;
import cn.dennishucd.qrcode.CaptureActivityHandler;
import cn.dennishucd.qrcode.InactivityTimer;
...
public class CaptureActivity extends BaseActivity implements Callback {
	...
	public void handleDecode(Result obj, Bitmap barcode) {
		...
		mTime.setText(TimeUtil.formatDate(this, obj.getTimestamp()));
