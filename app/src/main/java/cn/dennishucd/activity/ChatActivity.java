		...
		mSend.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (!TextUtils.isEmpty(content)) {
					...
					result.setTime(TimeUtil.getTime(ChatActivity.this));
					result.setType(1);
	...
	private void getChat() {
		...
		if (mKXApplication.mChatResults.isEmpty()) {
			...
			try {
				...
				params.add(new BasicNameValuePair("uidx", "\""+mUid+"\"")); 
				String json =LoadUtil.HttpPostText("PersonChatServlet", params);
	...
	public class ChatAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			case 1:
				...
				holder.outAvatar.setImageBitmap(mKXApplication.getAvatar(Utils.Avatar));
