 ...
 * 
 */
public class PhotoPictureDetailActivity extends BaseActivity {
	...
	private void setListener() {
		...
		mSaveas.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// 获取当前照片的编号
				String image = mPhotoResult.getImages().get(mCurrentPosition)
						.getImage();
				// 获取当前照片
	...
	private class PhotoGalleryAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			// 获取图片的路径
			String photo = mPhotoResult.getImages().get(position).getImage();
			Bitmap bitmap = null;
			// 如果等于则获取默认的照片否则获取相对应的照片
