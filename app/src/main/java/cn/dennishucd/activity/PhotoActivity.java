...
import cn.dennishucd.result.PhotoDetailResult;
	...
	private void setListener() {
		...
		mDisplay.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				// ID为空时为当前用户
				if (mUid == null) {
					intent.putExtra("result",mKXApplication.mMyPhotoResults.get(arg2));
				} else {
					intent.putExtra("result",mKXApplication.mFriendPhotoResults.get(mUid).get(arg2));
				}
