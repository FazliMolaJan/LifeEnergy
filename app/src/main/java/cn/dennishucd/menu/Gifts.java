...
import cn.dennishucd.uibase.MyListView;
import cn.dennishucd.uibase.XGridView;
...
public class Gifts {
	...
	private XGridView mDisplay;
	private MyListView mFriendsList;
	private OnOpenListener mOnOpenListener;

	public Gifts(Context context, LifeApplication application) {
		mContext = context;
	...
	private void findViewById() {
		...
		mDisplay = (XGridView) mGifts.findViewById(R.id.gifts_display);
