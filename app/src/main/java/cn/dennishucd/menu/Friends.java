...
import cn.dennishucd.activity.FriendFindActivity;
...
import cn.dennishucd.uibase.MyLetterListView;
import cn.dennishucd.uibase.FlipperLayout.OnOpenListener;
import cn.dennishucd.uibase.MyLetterListView.OnTouchingLetterChangedListener;
...
public class Friends {
	...
	public Friends(Context context, LifeApplication application) {
		mContext = context;
	...
	private void findViewById() {
		...
		mAdd = (Button) mFriends.findViewById(R.id.friends_new);
	...
	private void setListener() {
		...
		mAdd.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				...
				intent.setClass(mContext, FriendFindActivity.class);
	...
	private void getMyFriends() {
		if (mKXApplication.mMyFriendsResults.isEmpty()) {
			...
			try {
				String json=LoadUtil.HttpGetText("PersonFriendsServlet?uid="+"\""+Utils.UID+"\"");
