...
public class SeekCircleView extends ProgressCircle
{
	/**
	...
	public interface OnSeekCircleChangeListener
	{
		 ...
		 */
		void onProgressChanged(SeekCircleView seekCircle, int progress, boolean fromUser);
		 ...
		 */
		void onStartTrackingTouch(SeekCircleView seekCircle);
		 ...
		 *            The SeekCircle in which the touch gesture began
		 */
		void onStopTrackingTouch(SeekCircleView seekCircle);
	}
	 ...
	 * 
	 * @see SeekCircleView.OnSeekCircleChangeListener
	 */
...
//				SystemConst.seekCiecleFirst = false;
	...
	public void updateTouchProgress(int progress)
	{
		boolean result = super.updateProgress(progress);
		if (result)
		{
