...
public class MyScrollView extends ScrollView {
	...
	private View line;// 顶部拉线

	private int initTop, initbottom;// 初始高度
	private int top, bottom;// 拖动时时高度。
	private int init_line_bottom, line_bottom;// 最初状态，时时状态
	...
	public void commOnTouchEvent(MotionEvent ev) {
		...
		case MotionEvent.ACTION_DOWN:
			...
			line_bottom = init_line_bottom = line.getBottom();// 获取最初状态
			break;
		...
		case MotionEvent.ACTION_MOVE:
			...
			if (isMoveing) {
				...
				/** line drag **/
				line_bottom += (deltaY / 3);
				line.layout(line.getLeft(), line.getTop(), line.getRight(),
						line_bottom);
	...
	public void animation() {
		...
		/** line **/
		TranslateAnimation taaa = new TranslateAnimation(0, 0, line.getTop(),
				init_line_bottom);
		ta.setDuration(200);
